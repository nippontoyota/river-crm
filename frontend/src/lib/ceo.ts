...
export type Overview = { generated_at: string; mode: string; etbr: Record<string, number>; conversions: Record<string, number | null>; current: Record<string, number>; activity: Record<string, number | null>; finance: Record<string, number | string | null>; complaints: Record<string, unknown>; coverage: Record<string, number>; targets: Target; branches: ReportRow[]; trend?: ReportRow[]; trend_interval?: string; previous_etbr?: Record<string, number> | null; ageing?: Record<string, number> };
